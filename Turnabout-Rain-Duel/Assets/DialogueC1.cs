...
public class DialogueC1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ChoiceOne choiceOneScript = choiceOne.GetComponent<ChoiceOne>();
        ChoiceTwo choiceTwoScript = choiceTwo.GetComponent<ChoiceTwo>();

       
        //Revert all animations back to idle here.
